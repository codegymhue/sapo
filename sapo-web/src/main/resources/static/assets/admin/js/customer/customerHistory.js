              ...
              <div class="MuiBox-root jss5998 jss5978">
                <div class="MuiPaper-root jss6031 sapo-grid MuiPaper-elevation1 MuiPaper-rounded">
                  <div class="MuiTableContainer-root jss6032 sapo-grid-header-wrapper">
                    <table id="showShippingAddress" class="MuiTable-root jss6033 sapo-grid-header table table-hover" style=" width: 100%;" >
...
let modalCongNo = ` <div class="MuiBox-root jss828 jss820" >
                        <div class="MuiPaper-root jss864 sapo-grid MuiPaper-elevation1 MuiPaper-rounded">
                            <div class="MuiTableContainer-root jss865 sapo-grid-header-wrapper">
                                <table class="MuiTable-root jss866 sapo-grid-header table table-hover"  aria-labelledby="tableTitle"
                        ...
                        <div class="MuiBox-root jss1378 jss1375">
                            <div class="MuiPaper-root jss1381 sapo-grid MuiPaper-elevation1 MuiPaper-rounded">
                                <div class="MuiTableContainer-root jss1382 sapo-grid-header-wrapper">
                                    <table id="showCustomerOrderHistory" class="showCustomerOrderHistory table table-hover">
                                    <thead>
                                        <tr class="MuiTableRow-root MuiTableRow-head">
...
function deleteEventModelShow() {
    ...
    $('#contacts').css({
        'color': 'rgb(116, 124, 135)', 'border': 'none'
    })
    $('#debts').css({
        'color': 'rgb(116, 124, 135)', 'border': 'none'
    })
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        return `<a id="jss6532" style="color: #0a77bb">${row.order_code}</a>`;
                    }
                },
                {
                    targets: 2,
                    render: function (data, type, row, meta) {
                        ...
                        return `<a >  ${row.create_at != null ? moment(row.create_at).format('DD/MM/yyyy hh:ss') : "---"}</a>`;
                    }
                }
            ],
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        return `
                                <p          style="padding-right: 6px;">${row.mobile != null ? (row.mobile) : "--"}</p>`
                    }
                },
                {
                    targets: 5,
                    render: function (data, type, row, meta) {
                        return `
                                <p    style="padding-right: 6px;">${row.zipCode != null ? (row.zipCode) : "--"}</p>`
                    }
                },
                {
                    targets: 6,
                    render: function (data, type, row, meta) {
                        return `
                                <p    style="padding-right: 6px;">${row.email != null ? (row.email) : "--"}</p>`
                    }
                }
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return `
                                <p class="text-end"
                                           style="padding-right: 6px;">${row.grandTotal != null ? (new Intl.NumberFormat('vi-VN', {
                            style: 'currency',
                            currency: 'VND'
                        }).format(row.grandTotal)) : "0"}</p>`
                    }
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        return `<a >  ${row.createdAt != null ? moment(row.createdAt).format('DD/MM/yyyy hh:ss') : "---"}</a>`;
                    }
                },
