...
@Embeddable
public class RbacOperationPermissionId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        RbacOperationPermissionId that = (RbacOperationPermissionId) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(permissionId, operationId);
    }
